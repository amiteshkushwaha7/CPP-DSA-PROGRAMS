...
public:
    ...
    void appendElement(X);

    // Method to insert a new element at specific index
    void insertSpecificElement(int, X);
...
template <typename X>
bool Array<X>::checkArray_isEmptyorNot()
{
    if (lastIndex == -1)
        return true;
    return false;
...
template <typename X>
void Array<X>::appendElement(X element)
{
...
template <typename X>
void Array<X>::insertSpecificElement(int index, X element)
{
    if (lastIndex == (capacity - 1))
...
template <typename X>
void Array<X>::editElement(int index, X element)
{
    if (index > lastIndex)
...
template <typename X>
void Array<X>::deleteElement(int index, X element)
{
    int j;
    if (lastIndex == -1)
...
template <typename X>
bool Array<X>::checkArray_isFullorNot()
{
    if (lastIndex == (capacity - 1))
        return true;
    else
...
template <typename X>
int Array<X>::getElemnt(int index)
{
    if (lastIndex == -1)
        return 0;
    else if (index > lastIndex)
...
template <typename X>
int Array<X>::countElements()
{
    return (lastIndex + 1);
}

template <typename X>
int Array<X>::findElement(X element)
{
    for (int i = 0; i <= lastIndex; i++)
    {
        if (ptr[i] == element)
...
template <typename X>
void Array<X>::searchElement(X element)
{
    if (lastIndex == -1)
        cout << "Array is not initialized!";
    else
...
template <typename X>
void Array<X>::rotateArray(char direction, int position)
{
    if (lastIndex == -1)
        cout << "Array is not initialized!";
    else
...
template <typename X>
void Array<X>::removeDuplicateElements()
{
    if (lastIndex == -1)
        cout << "Array is not initialized!";
    else
...
template <typename X>
void Array<X>::swapElements(int index1, int index2)
{
    if (lastIndex == -1)
...
int main()
{
    ...
    arr.appendElement(15);
    arr.appendElement(20);
    arr.appendElement(25);
    arr.displayArray();
    cout<<endl;
    
    Array <float>arr1(5);
    arr1.appendElement(5.5);
    arr1.appendElement(10.5);
    arr1.appendElement(15.5);
    arr1.appendElement(20.5);
    arr1.appendElement(25.5);
    arr1.displayArray();
    cout<<endl;

    Array <string>arr2(5);
    arr2.appendElement("Amitesh");
    arr2.appendElement("Rajan");
    arr2.appendElement("Ankur");
    arr2.appendElement("Dheeraj");
    arr2.appendElement("Shiva");
    arr2.displayArray();
...
//     cout << endl
//          << endl
//          << "1.Check array is empty or not" << endl;
